...
##------ DCC Count ----------------------------------------------------------------
set label "DCC count: 46" at 6.6,260 center font "Times_New_Roman,22"
...
##------ PLOT --------------------------------------------------------------------
plot \
"vga_5_15mV_dist.txt" using 1:2 with linespoints linewidth 2 pt 5 ps 2 lc 1 title "15 mV", \
"vga_5_15mV_dist.txt" using 1:3 with linespoints linewidth 2 pt 5 ps 2 lc 1 notitle , \
